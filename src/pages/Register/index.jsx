...
const Register = () => {
    return (
        <DefaultLayout>
            <div className='relative flex-col w-[30%] left-1/2 -translate-x-1/2 mt-20'>
                ...
                <button className='flex rounded-lg bg-teal-300 text-2xl font-bold justify-center items-center p-2 w-full'>Register</button>
